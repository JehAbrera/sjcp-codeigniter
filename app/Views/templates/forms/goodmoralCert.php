        ...
        <div class="p-8">
            ...
            <div>
                <div class="form-control">
                    ...
                    <input type="text" id="purp" name="purp" placeholder="Requirementd for Wedding"
                        class="input input-bordered w-full" pattern="[A-Za-zÀ-ÖØ-öø-ÿ.\s\-]*" required />
                </div>
            </div>
            <br>
            <br>
            <div class="gap-x-8">
                ...
                <div class="grid grid-cols-2 gap-x-8">
                    ...
                    <div class="form-control">
                        <div class="label">
                            <span class="label-text">Barangay Certificate</span>
                        </div>
                        <input type="file" id="barangay" name="barangay" accept="image/*"
                            class="file-input file-input-bordered w-full max-w-xs bg-white" required />
                    </div>
                    <div class="form-control">
                        <div class="label">
                            <span class="label-text">Kawan Certificate</span>
                        </div>
                        <input type="file" id="kawan" name="kawan" accept="image/*"
                            class="file-input file-input-bordered w-full max-w-xs bg-white" required />
                    </div>
                </div>
            </div>
