                    ...
                    <?php if ($mode == "login") { ?>
                        ...
                        if ($step == 1) { ?>
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" placeholder="John Rey" name="fn" value="<?= set_value('fn', $fn) ?>" class="input input-bordered" required />
                            </div>
                            <div class="form-control">
                                <label class="label">
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" placeholder="Abrera" name="ln" value="<?= set_value('ln', $ln) ?>" class="input input-bordered" required />
                            </div>
                        ...
                        <?php } elseif ($step == 2) { ?>
                            ...
                            <div class=" flex gap-2 justify-center mt-6">
                                ...
                                <button type="submit" class=" btn btn-success w-fit" name="submit" value="Submit">Next <i data-lucide="chevron-right"></i></button>
                            </div>
                            <?= form_close() ?>
                        <?php } elseif ($step == 3) { ?>
