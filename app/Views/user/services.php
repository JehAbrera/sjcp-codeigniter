                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal1" class="btn"><i data-lucide="X"></i></label>
                        </div>
        ...
        <div class=" flex items-center justify-center">
            <div class="card bg-base-100 shadow-xl image-full w-full">
                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal2" class="btn"><i data-lucide="X"></i></label>
                        </div>
                        <h3 class="font-bold text-lg">Hello!</h3>
                        <p class="py-4">This modal works with a hidden checkbox!</p>
                    </div>
        ...
        <div class=" flex items-center justify-center">
            <div class="card bg-base-100 shadow-xl image-full w-full">
                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal3" class="btn"><i data-lucide="X"></i></label>
                        </div>
                        <h3 class="font-bold text-lg">Hello!</h3>
                        <p class="py-4">This modal works with a hidden checkbox!</p>
                    </div>
        ...
        <div class=" flex items-center justify-center">
            <div class="card bg-base-100 shadow-xl image-full w-full">
                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal4" class="btn"><i data-lucide="X"></i></label>
                        </div>
                        <h3 class="font-bold text-lg">Hello!</h3>
                        <p class="py-4">This modal works with a hidden checkbox!</p>
                    </div>
        ...
        <div class=" flex items-center justify-center">
            <div class="card bg-base-100 shadow-xl image-full w-full">
                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal5" class="btn"><i data-lucide="X"></i></label>
                        </div>
                        <h3 class="font-bold text-lg">Hello!</h3>
                        <p class="py-4">This modal works with a hidden checkbox!</p>
                    </div>
        ...
        <div class=" flex items-center justify-center">
            <div class="card bg-base-100 shadow-xl image-full w-full">
                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal6" class="btn"><i data-lucide="X"></i></label>
                        </div>
                        <h3 class="font-bold text-lg">Hello!</h3>
                        <p class="py-4">This modal works with a hidden checkbox!</p>
                    </div>
        ...
        <div class=" flex items-center justify-center">
            <div class="card bg-base-100 shadow-xl image-full w-full">
                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal7" class="btn"><i data-lucide="X"></i></label>
                        </div>
                        <h3 class="font-bold text-lg">Hello!</h3>
                        <p class="py-4">This modal works with a hidden checkbox!</p>
                    </div>
        ...
        <div class=" flex items-center justify-center">
            <div class="card bg-base-100 shadow-xl image-full w-full">
                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal8" class="btn"><i data-lucide="X"></i></label>
                        </div>
                        <h3 class="font-bold text-lg">Hello!</h3>
                        <p class="py-4">This modal works with a hidden checkbox!</p>
                    </div>
        ...
        <div class=" flex items-center justify-center">
            <div class="card bg-base-100 shadow-xl image-full w-full">
                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        <div class="modal-action mt-0 mb-4">
                            <label for="modal9" class="btn"><i data-lucide="X"></i></label>
                        </div>
                        <h3 class="font-bold text-lg">Hello!</h3>
                        <p class="py-4">This modal works with a hidden checkbox!</p>
                    </div>
